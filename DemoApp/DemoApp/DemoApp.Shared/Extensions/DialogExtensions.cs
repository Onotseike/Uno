...
namespace DemoApp.Extensions
{
    ...
    {
        internal static async Task<ContentDialogResult> ShowOneAtATimeAsync(this ContentDialog dialog, TimeSpan? timeout = null, CancellationToken? token = null) => await DialogManager.OneAtATimeAsync(async () => await dialog.ShowAsync(), timeout, token);
